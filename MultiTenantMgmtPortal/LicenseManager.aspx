<%@ Page Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" Inherits="ManagementPortal.LicenseManager" CodeBehind="LicenseManager.aspx.vb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="Server">
    ...
    <div id="contentinner" class="base1">
        <div class="toolbar">
            ...
            <asp:Button ID="btnExtendTrial" runat="server" cssclass="toolbtn" Text="<%$Resources:Strings, ExtendTrial %>" CausesValidation="false" />
            <span class="tooldiv" runat="server" id="extendTrialDiv"></span>
            <asp:Button ID="btnImport" runat="server" cssclass="toolbtn" Text="<%$Resources:Strings, ImportTemplates %>" Visible="false" CausesValidation="false" />
            <span class="tooldiv" runat="server" id="importDiv" visible="false"></span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div>
                            ...
                            <button class="clip" type="button" data-clipboard-action="copy" data-clipboard-target="#Content_lblTenancyKey"><%=Resources.Strings.CopyToClipboard%></button>
