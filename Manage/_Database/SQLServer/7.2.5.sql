/*
** Database Update package 7.2.5
*/

--set version
truncate table dbversion;
go
insert into dbversion(dbversion) values ('7.2.5');
go
...
GO
ALTER TABLE dbo.Template_Group_Item
	DROP CONSTRAINT PK_Template_Group_Item
GO
...
ALTER TABLE dbo.Template_Group_Item ADD CONSTRAINT
	PK_Template_Group_Item PRIMARY KEY NONCLUSTERED
	(
	Template_Group_Item_ID
	)
GO
CREATE CLUSTERED INDEX [IX_Template_Group_Item_Group_Guid] ON [Template_Group_Item] 
(
