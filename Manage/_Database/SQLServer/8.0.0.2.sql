/*
** Database Update package 8.0.0.2
*/

--set version
truncate table dbversion;
go
insert into dbversion(dbversion) values ('8.0.0.2');
go

--2025
INSERT INTO Global_Options(OptionCode, OptionDescription, OptionValue)
VALUES ('PRODUCER_URL', 'URL to the Producer application', '');

INSERT INTO Global_Options(OptionCode, OptionDescription, OptionValue)
VALUES ('DIRECTOR_URL', 'URL to the Director application', '');
GO
