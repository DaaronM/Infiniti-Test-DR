...
GO
insert into dbversion(dbversion) values ('10.2.9');
GO
...
AS
	...
	WHERE  (Template_Log.Answer_File IS NOT NULL AND CAST(Template_Log.Answer_File as nvarchar(max)) != '') AND 
...
DROP PROCEDURE spTenant_ResetTenancyKeyDateTime;
GO
create PROCEDURE [dbo].spTenant_ResetTenancyKeyDateTime  
