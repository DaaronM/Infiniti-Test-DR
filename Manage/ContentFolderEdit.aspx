<%@ Page Language="VB" MasterPageFile="~/Manage.master" AutoEventWireup="false" Inherits="Intelledox.Manage.ContentFolderEdit" Codebehind="ContentFolderEdit.aspx.vb" %>
                ...
                <tr>
                    <td>
                        ...
                        <table class="subfield" cellspacing="0" role="presentation">
                            ...
                            <tr class="inforow">
                                <td><%= Resources.Strings.InfoContentFolderGroups%></td>
                            </tr>
                            <tr>
